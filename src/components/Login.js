        ...
        <div class="container">
          <div class="login-form">
            <div class="main-div">
              ...
              <button onClick={this.cadastrarUsuario} type="submit" class="btn btn-warning">Cadastrar</button>
                &emsp;
              <button onClick={this.loginUsuario} type="submit" class="btn btn-warning">Login</button>
            </div>
          </div>
        </div>
      </body>
