        ...
        return (
          <div>
            <AppBar position="static" color="default">
              <Toolbar>
                <Button color="warning" onClick={this.addPlace} type="submit">Registrar Lugar</Button>
                <Button color="warning" onClick={this.togglec} type="text">Nova Categoria</Button>
                <Button color="warning" onClick={this.togglep} type="text">Novo lugar</Button>
                <Button color="warning" href="/map" type="text">Lista de lugares</Button>
                <Button color="warning" onClick={this.logout} type="submit">Sair</Button>
              </Toolbar>
            </AppBar>
            ...
            <Modal isOpen={this.state.modalp} toggle={this.togglep} className={this.props.className}> {/*Modal de cadastrar lugares*/}
              ...
              <ModalFooter>
                ...
                <button onClick={this.addPlace} type="submit" class="btn btn-info">Salvar</button>
              </ModalFooter>
            </Modal>
            ...
            <Modal isOpen={this.state.modalc} toggle={this.togglec} className={this.props.className}> {/*Modal de cadastrar categorias*/}
              ...
              <ModalFooter>
                <button class="btn btn-info">Cancelar</button>          
                <button onClick={this.addCategory} type="submit" class="btn btn-info">Salvar</button>
              </ModalFooter>
            </Modal>                  
          </div>
        );
