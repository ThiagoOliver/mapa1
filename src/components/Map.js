            ...
            <div className='box'>
                ...
                <div className='edition '>
                    <AppBar position="static" color="inherit">
                        <Toolbar>
                            <Button color="inherit" onClick={this.togglec} type="text">Nova categoria</Button>
                            <Button color="inherit" onClick={this.togglep} type="text">Novo Lugar</Button>
                           <Button color="inherit" /*onClick={this.listPlaces}*/ href="/map" type="submit">Listar Locais</Button>
                            <Button color="inherit" onClick={this.logout} type="submit">Sair</Button>
                        </Toolbar>
                    </AppBar>
                ...
                <Modal isOpen={this.state.modalp} toggle={this.togglep}
                    ...
                    <ModalHeader toggle={this.togglep}> Salvar local </ModalHeader>
                    <ModalBody>
                        <input
                    ...
                    <ModalFooter>
                        <button onClick={this.addPlace} type="submit" className="btn btn-warning">Salvar</button>
                    </ModalFooter>
                </Modal>

                <Modal isOpen={this.state.modalc} toggle={this.togglec}
                       className={this.props.className}> {/*Modal de cadastrar categorias*/}
                    <ModalHeader toggle={this.togglec}>Salvar nova categoria</ModalHeader>
                    <ModalBody>
                        <input
                            className="form-control form-control-lg"
                    ...
                    <ModalFooter>
                        <Button onClick={this.addCategory} className="btn btn-warning">Salvar</Button>
                    </ModalFooter>
                </Modal>
            </div>
        );
